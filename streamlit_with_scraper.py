...
st.set_page_config(
    page_title="CAGR Scraper & Monitor",
    page_icon="📊",
    layout="wide"
)

st.title("📊 CAGR Analyst Estimates Scraper & Monitor")
...
if st.sidebar.button("🔄 Start Manual Scrape", disabled=st.session_state.scraping_in_progress):
